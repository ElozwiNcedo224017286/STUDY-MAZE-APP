...
const REWARDS = [
  { icon: '📶', name: '50MB Data Bundle', partner: 'Vodacom', cost: 400 },
  { icon: '☎️', name: 'R10 Airtime', partner: 'MTN', cost: 500 },
  { icon: '🛒', name: 'R50 Voucher', partner: 'Takealot', cost: 1000 },
  { icon: '🥫', name: 'R30 Grocery Voucher', partner: 'Shoprite', cost: 700 },
  { icon: '🧺', name: 'R30 Voucher', partner: 'Pick n Pay', cost: 700 },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScreenHeader
        title="Rewards"
        titleHighlight="Shop"
        subtitle="Keep learning and playing to reach these long-term reward goals."
      />
